...
def run_training():
    ...
    agent.load(os.path.join(project_root, 'q_table_final.npy'))
    agent.epsilon = 0.0
    agent.epsilonMin = 0.0
    agent.epsilonDecay = 1.0
    ...
    csv_path = os.path.join(project_root, f"results_{MAP_TYPE}_{timestamp}_generalization.csv")
    ...
    for episode in range(NUM_EPISODES):
        ...
        start_x, start_z = sample_random_start()
